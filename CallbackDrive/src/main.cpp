...
void userDrive(){
  ...
  while (true) {
    ...
    if (control2.ButtonB.pressing()){ //look into using .pressed instead for a cleaner code
      mtr_move.spinTo(90.0, degrees, false);/*will need to look up this keyword: https://api.vexcode.cloud/v5/search/bool%20vex::motor::spinTo(double%20rotation,%20rotationUnits%20units,%20double%20velocity,%20velocityUnits%20units_v,%20bool%20waitForCompletion=true)/vex::motor/function*/
    }
    /*else
